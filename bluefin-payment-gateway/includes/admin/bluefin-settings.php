...
$bluefin_settings = [
	...
	'account_id'                         => [
		...
		'type'        => 'text',
		'description' => __( 'Required. PayConex Account Identifier', 'bluefin-payment-gateway' ),
		'desc_tip'    => true,
		// 'required'    => true,
	],
	'merchant_api_key_id'                => [
		'title'       => __( 'API Key Identifier* ', 'bluefin-payment-gateway' ),
		'type'        => 'text',
		'description' => __( 'Required. Merchant  API Key Identifier', 'bluefin-payment-gateway' ),
		'desc_tip'    => true,
	],
	'merchant_api_key_secret'            => [
		'title'       => __( 'API Key Secret* ', 'bluefin-payment-gateway' ),
		'type'        => 'password',
		'description' => __( 'Required. Merchant  API Key Secret', 'bluefin-payment-gateway' ),
		'desc_tip'    => true,
	],
	'iframe_config_id'                   => [
		'title'       => __( 'iFrame Configuration Identifier* ', 'bluefin-payment-gateway' ),
		'type'        => 'text',
		'description' => __( 'Required. iFrame Configuration used by the Checkout Component. Preconfigure payment methods and their settings', 'bluefin-payment-gateway' ),
		'desc_tip'    => true,
	],
	'use_sandbox'                        => [
	...
	'use_auth_only'                      => [
		...
		'type'        => 'checkbox',
		'description' => __( 'Upon Order Confirmation, WooCommerce Admin -> Orders -> Select the order to capture and click on the Capture button', 'bluefin-payment-gateway' ),
	...
	'iframe_timeout'                     => [
		...
		'type'        => 'text',
		'description' => __( 'Required. Iframe Timeout in seconds', 'bluefin-payment-gateway' ),
